...
pod_yaml = "apiVersion: v1\n" + \
           ...
           "  containers:\n" + \
           "    - name: " + PODNAME + "\n" + \
           "      image: 018573873269.dkr.ecr.us-east-1.amazonaws.com/gstreamer:pravega-prod-latency\n" + \
...
def main():
    ...
    parser.add_argument('--pravega-controller-uri', default='pravega-pravega-controller:9090')
    ...
    while writers < args.num_writers_and_streams:
        ...
        worker_node = "ip-192-168-62-125.ec2.internal" #"neardata-2204-work0" + str(writers % NODES + 1)
